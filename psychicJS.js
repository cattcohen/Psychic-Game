...
document.onkeyup = function(event) {
    ...
    if (guessesLeft > 0) {
        if (userGuess == letterToGuess) {
            ...
            alert("Good Job! Anyone can be psychic, however, this power does not come without practice. Seems you have done your work. Try another!");
            reset();
        }
    } else if (guessesLeft == 0) {
        losses++;
        document.querySelector('#loss').innerHTML = "Losses: " + losses;
        alert("Deliberate focus is the key. Take your time.. try again!");
